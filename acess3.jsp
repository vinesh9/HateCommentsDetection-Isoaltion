...
stmt.executeUpdate("update members set status='Disallow' where gid='" + tgid + "' and usrid=" + tid);
out.println("<P style='font-family:cursive;font-size:24px;text-align:center;'>STATUS UPDATED SUCCESSFULLY..!</P>");
con.close();
