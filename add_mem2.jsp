...
tusid=request.getParameter("usid");
Class.forName("oracle.jdbc.driver.OracleDriver");
con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","comments","comments");
Statement stmt=con.createStatement();
//out.println("insert into members values('" + tgid + "'," + tusid + ",'Allow')");
stmt.executeUpdate("insert into members values('" + tgid + "'," + tusid + ",'Allow')");
out.println("<p class='w3-panel w3-center'>Member Added Successfully!</p>");
con.close();
}
catch(Exception ee)
{
out.println("<p class='w3-panel w3-center'>This User is already in the Group</p>");
}
%>
</section>
